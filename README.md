...
| **PhasePowerChip** (L1/L2/L3) | Import/Export per fázis (W) | `P1ReadingDto.powerImportL1W.../powerExportL1W...` | P1 meter `instantaneous_power_import_l1.../export_l1...` — közvetlenül a meterből, nincs fallback számítás |
| **HousePhaseChip** (L1/L2/L3) | Ház fogyasztás per fázis (W) | Számolt | `solarPerPhase + importLxW - exportLxW`, ahol `solarPerPhase = inverterPowerW / 3` (SUN2000-5KTL-M1 szimmetrikus inverter). Aszimmetrikus terhelésnél (L1=bojler 10A, L2=klíma 10A, L3=ház 32A) a fázisok egyszerre importálhatnak és exportálhatnak — a P1 meter per-fázis értékei közvetlenül használva |
