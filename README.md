...
| **P1HistoryChart** | Teljesítmény görbe (import/export/consumption) | `P1ReadingDto` lista (100-1440 pont) | Consumption = `realConsumptionW` (Hub T-5 szinkronizált). Inverter power = `inverterPowerW` (Hub `findInverterPower` 10 perces tolerance-szal keres a Kiosk API 5 perces késése miatt) |
